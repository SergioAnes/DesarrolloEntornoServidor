...
function altaEmpleado ($conexion, $nombreEmpleado, $dni, $fechaNacimiento, $Nombredepartamento) {
	$insertarEmpleado = "INSERT INTO empleado (dni, nombre_e, fec_nac, nombre_d) VALUES ('$dni', '$nombreEmpleado', '$fechaNacimiento', '$Nombredepartamento')";
	if (mysqli_query($conexion, $insertarEmpleado)) {
    	echo "Se ha creado un nuevo empleado";
	} else {
    	echo "Error en la inserción del empleado: ";
	}
	mysqli_close($conexion);
}//fin altaDepartamento
